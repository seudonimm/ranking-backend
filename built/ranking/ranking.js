...
export const decayDeviation = (currDeviation, timeSinceLastRating) => {
...
export const calcNewRating = (ownRating, ownDeviation, otherRating, otherDeviation, outcome) => {
    let g = calcG(otherDeviation);
    let e = calcE(ownRating, ownDeviation, otherRating, otherDeviation);
...
export const calcNewDeviation = (ownRating, ownDeviation, otherRating, otherDeviation) => {
    let d2 = calcD2(ownRating, ownDeviation, otherRating, otherDeviation);
